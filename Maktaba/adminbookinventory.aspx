<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="Maktaba.WebForm8" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" height="150px" width="100px" src="BookInventory/books.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
...
<%--                              <asp:LinkButton class="btn btn-primary" ID="LkBtnGo" runat="server" OnClick="LinkButton4_Click" Width="29px"><i class="fas fa-check-circle"></i></asp:LinkButton>--%>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-8">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DPLLanguage" runat="server">
                              ...
                              <asp:ListItem Text="Kelenjin" Value="Kelenjin" />
                              <asp:ListItem Text="Teso" Value="Teso" />
                     ...
                     <div class="col-md-4">
                        <label>Genre</label>
                        <div class="form-group">
                           <asp:ListBox CssClass="form-control" ID="ListBGenre" runat="server" SelectionMode="Multiple" Rows="5">
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:KitabuConnectionString %>" SelectCommand="SELECT * FROM [Book]"></asp:SqlDataSource>
                     <div class="col">
                                       ...
                                       <div class="row">
                                          <div class="col-lg-10">
                                             ...
                                             <div class="row">
                                                <div class="col-12">
                                                   Description -
                                                   <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Smaller" Text='<%# Eval("BookDesc") %>'></asp:Label>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="col-lg-2">
