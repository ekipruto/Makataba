<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookissuing.aspx.cs" Inherits="Maktaba.WebForm6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:TextBox class="form-control" ID="TxtBookId" runat="server" placeholder="Book ID"></asp:TextBox>
 ...
 <div class="form-group">
 <asp:TextBox CssClass="form-control" ID="TxtMname" runat="server" placeholder="Member Name" ReadOnly="True"></asp:TextBox>
 </div>
 </div>
 <div class="col-md-6">
 <label>Book Name</label>
 <div class="form-group">
 <asp:TextBox CssClass="form-control" ID="TxtBkName" runat="server" placeholder="Book Name" ReadOnly="True"></asp:TextBox>
 </div>
 </div>
 </div>
 <div class="row">
 ...
 <div class="form-group">
 <asp:TextBox CssClass="form-control" ID="TxtIssueDt" runat="server" placeholder="Start Date" TextMode="Date"></asp:TextBox>
 </div>
 </div>
 <div class="col-md-6">
 <label>Due Date</label>
 <div class="form-group">
 <asp:TextBox CssClass="form-control" ID="TxtDueDt" runat="server" placeholder="End Date" TextMode="Date" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
 </div>
 </div>
 </div>
 <div class="row">
 ...
 <div class="row">
 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:KitabuConnectionString %>" SelectCommand="SELECT * FROM [BookIssue]"></asp:SqlDataSource>
 <div class="col">
