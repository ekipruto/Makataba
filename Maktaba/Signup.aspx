<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="Maktaba.WebForm3" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <label>State</label>
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DPLState" runat="server">
                  ...
                  <div class="row">
                     <div class="col">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TxtMemberId" runat="server" placeholder="Member Id" TextMode="Number" Rows="2"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                  <div class="col">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TxtPassword1" runat="server" placeholder="Password" TextMode="Password" Rows="2"></asp:TextBox>
                        </div>
                     </div>
                  </div>                  <div class="row">
                     <div class="col">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <label>User ID</label>
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TxtUseId" runat="server" placeholder="User ID" ></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <label>Password</label>
...
<%--                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TxtNPassword" runat="server" placeholder="Email ID" TextMode="Password"></asp:TextBox>
                        </div>
                     </div>--%>
                  </div>
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <center>
                           <div class="form-group">
                              <asp:Button class="btn btn-primary btn-block btn-lg" ID="BtnSignup" runat="server" Text="SignUp" OnClick="BtnSignup_Click" />
                           </div>
                        </center>
                     </div>
                  </div>
